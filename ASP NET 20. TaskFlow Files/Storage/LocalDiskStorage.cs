...
public class LocalDiskStorage : IFileStorage
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var releativePath = Path.Combine(folderKey, storedFileName);

        var fullPath = Path.Combine(_basePath, releativePath);
        ...
        {
            StorageKey = releativePath.Replace('\\', '/'),
    ...
    public Task DeleteAsync(string storageKey, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogWarning("Could not delete file from {Path}", fullPath);
        }
