    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TaskAttachment>(
            ta=>
            {
                ...
                ta.Property(ta => ta.OriginalFileName)
                  .IsRequired()
                  .HasMaxLength(500);

                ta.Property(ta => ta.StoredFileName)
                  .IsRequired()
                  .HasMaxLength(200);

                ta.Property(ta => ta.ContentType)
                  .IsRequired()
                  .HasMaxLength(100);

                ta.Property(ta => ta.UploadedByUserId)
                  .IsRequired()
                  .HasMaxLength(450);

                ta.HasOne(ta => ta.TaskItem)
                  .WithMany(t => t.Attachments)
                  .HasForeignKey(ta => ta.TaskItemId)
                  .OnDelete(DeleteBehavior.Cascade);

                ta.HasOne(ta => ta.UploadedByUser)
                  .WithMany()
